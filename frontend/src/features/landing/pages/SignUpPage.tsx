    ...
    <AuthLayout>
      ...
      <form onSubmit={handleSubmit} className="space-y-5" noValidate>
        <div className="space-y-2">
          <p className="text-xs font-semibold uppercase tracking-wider text-brand-blue/70">Account Type</p>
        ...
        <div>
          <label className="flex cursor-pointer items-start gap-2">
            ...
            <span className="text-xs text-brand-blue/60">
              I agree to the <span className="font-semibold text-brand-blue">Terms of Service</span> and{" "}
              <span className="font-semibold text-brand-blue">Privacy Policy</span>.
            </span>
          </label>
          {errors.terms ? <p className="mt-1.5 text-xs text-red-500">{errors.terms}</p> : null}
        </div>
