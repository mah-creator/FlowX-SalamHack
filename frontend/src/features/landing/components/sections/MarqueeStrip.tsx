...
export function MarqueeStrip() {
  ...
  return (
    <Container className="shrink-0">
      <div className="gsap-hidden flex flex-col items-center justify-between gap-12 pt-16 lg:flex-row lg:pt-0" data-marquee>
        ...
        <div className="gsap-hidden relative mb-12 hidden h-32 w-full max-w-sm items-center xl:flex" data-hero-card>
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                ...
                <p className="text-[9px] leading-tight text-black/70">{heroCards[currentCardIndex].desc}</p>
              </div>
            </motion.div>
          </AnimatePresence>
        </div>
