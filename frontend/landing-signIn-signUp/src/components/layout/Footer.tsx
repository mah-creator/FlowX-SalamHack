    ...
    <footer ref={footerRef} className="bg-[#0a0a0a] pt-24 pb-12 text-white">
      <div className="mx-auto w-full max-w-[1250px] px-6 md:px-12">
        <div className="mb-16">
          ...
          <p className="mt-6 max-w-md text-sm font-light leading-relaxed text-white/40" data-footer-desc>
            Cross-border transfers made faster, cheaper, and reliable for constrained regions.
          </p>
        </div>

        <div className="h-px bg-white/[0.06]" data-separator />

        <div className="grid grid-cols-2 gap-x-8 gap-y-10 py-12 md:grid-cols-4 md:gap-x-12 md:gap-y-8" data-footer-grid>
        ...
        >
          <div>
            <p className="text-xs text-white/25">© {currentYear} FlowX. All rights reserved.</p>
